...
part of 'firebase_login_response.dart';
...
/// @nodoc
@JsonSerializable()
class _$FirebaseLoginResponseImpl extends _FirebaseLoginResponse {
  const _$FirebaseLoginResponseImpl({required this.firebaseToken}) : super._();
  ...
  @override
  String toString() {
    return 'FirebaseLoginResponse(firebaseToken: $firebaseToken)';
  }
...
abstract class _FirebaseLoginResponse extends FirebaseLoginResponse {
  const factory _FirebaseLoginResponse({required final String firebaseToken}) =
      _$FirebaseLoginResponseImpl;
  const _FirebaseLoginResponse._() : super._();
