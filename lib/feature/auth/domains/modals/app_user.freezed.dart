...
abstract class $AppUserCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? token, String? firebaseToken});
}
...
class _$AppUserImpl extends _AppUser {
  const _$AppUserImpl({required this.token, required this.firebaseToken})
      : super._();
  ...
  @override
  String toString() {
    return 'AppUser(token: $token, firebaseToken: $firebaseToken)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, token, firebaseToken);
...
abstract class _AppUser extends AppUser {
  const factory _AppUser(
      ...
      required final String? firebaseToken}) = _$AppUserImpl;
